...
namespace Details
{
    ...
    constexpr CameraProjection kCameraProjection{
        .yFov = glm::radians(90.0f), .width = 1.0f, .height = 1.0f, .zNear = 0.01f, .zFar = 1000.0f
    };
        ...
        {
            {
                ...
                ImageHelpers::TransitImageLayout(
                    commandBuffer, probeImage, ImageHelpers::kCubeColor, layoutTransition);
            }
...

            {
                const ImageLayoutTransition layoutTransition{ vk::ImageLayout::eGeneral,
                    ...
                    PipelineBarrier{ SyncScope::kRayTracingShaderWrite, SyncScope::kBlockNone } };
