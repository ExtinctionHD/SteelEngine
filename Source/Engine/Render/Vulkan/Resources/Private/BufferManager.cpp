...
void BufferManager::UpdateBuffer(vk::CommandBuffer commandBuffer, vk::Buffer buffer, const BufferUpdater& updater) const
{
    const auto& [description, stagingBuffer] = buffers.at(buffer);
...
void BufferManager::ReadBuffer(vk::CommandBuffer commandBuffer, vk::Buffer buffer, const BufferReader& reader) const
{
    const auto& [description, stagingBuffer] = buffers.at(buffer);
