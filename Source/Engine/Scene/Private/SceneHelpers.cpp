...
void SceneHelpers::CopyComponents(const Scene& srcScene, Scene& dstScene, entt::entity srcEntity,
        entt::entity dstEntity, const std::map<entt::entity, entt::entity>& entities)
{
...
void SceneHelpers::CopyHierarchy(const Scene& srcScene, Scene& dstScene, entt::entity srcParent, entt::entity dstParent)
{
    std::map<entt::entity, entt::entity> entities;

    srcScene.EnumerateDescendants(srcParent,
