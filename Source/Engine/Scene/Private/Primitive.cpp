...
namespace Details
{
    ...
    static std::vector<glm::vec3> ComputeTangents(const std::vector<uint32_t>& indices, const std::vector<glm::vec3>& positions, const std::vector<glm::vec2>& texCoords)
    {
        Assert(!positions.empty());
...
Primitive::Primitive(std::vector<uint32_t> indices_, std::vector<glm::vec3> positions_, std::vector<glm::vec3> normals_, std::vector<glm::vec3> tangents_, std::vector<glm::vec2> texCoords_)
