...
namespace ImageLoader
{
    ...
    static ImageSource LoadLdrImage(const Filepath& filepath, uint32_t requiredChannelCount)
    {
        ...
        imageSource.data.data = stbi_load(filepath.GetAbsolute().c_str(), &x, &y, &actualChannelCount, static_cast<int32_t>(requiredChannelCount));
    ...
    static ImageSource LoadHdrImage(const Filepath& filepath, uint32_t requiredChannelCount)
    {
        ...
        hdrData.data = stbi_loadf(filepath.GetAbsolute().c_str(), &x, &y, &actualChannelCount, static_cast<int32_t>(requiredChannelCount));
